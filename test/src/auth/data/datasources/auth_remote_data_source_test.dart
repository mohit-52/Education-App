...
void main() {
  ...
  setUpAll(() async {
    ...
    documentReference = await cloudStoreClient.collection('users').doc();
  ...
  group('signIn', () {
    ...
    test('should return [ServerException] when user is null after signing in',
        () async {
  ...
  group('updateUser', () {
    ...
    test('should update user password successfully when no Exception is thrown',
        () async {
    ...
    test(
        'should update user profile pic successfully when no Exception is thrown',
        () async {
      final newProfilePic = File('assets/images/onBoarding_backgroung.png');
